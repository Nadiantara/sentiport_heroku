...
def plot_total_language1(DATAFRAME):
  ...
  obj.savefig('sentiport/artifacts/fig_lang_1.png')
  
  return 'fig_lang_1.png', most_lang

def plot_detect_language2(DATAFRAME):
  '''
  ...
  lang[anotate_col] = pd.Series([percent_format.format(val * percent_coeff) for val in lang[anotate_col]], index = lang.index)
