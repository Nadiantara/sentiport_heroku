...
pdf.drawInlineImage(r'sentiport/utils/assets/cover_template_1.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/table_of_content.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/executive_summary.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/Introduction.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/review_analysis_by_time.png',0,0, width=1366, height=768)
...
# put review analysis by time template
pdf.drawInlineImage(r'sentiport/utils/assets/review_analysis_by_version.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/sentiment_analysis.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/review_language_analysis.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/template_negative_reviews.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/positive_review.png',0,0, width=1366, height=768)
...
pdf.drawInlineImage(r'sentiport/utils/assets/get_other_features.png',0,0, width=1366, height=768)
